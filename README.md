...
<p align="center">📱 零代码 UI 智能录制回放平台</p>
<p align="center">自动兼容任意宽高比分辨率屏幕，自动精准等待网络请求，录制回放快、准、稳！</p>
<p align="center" >
  <a href="https://github.com/TommyLemon/UIGO/tree/master/UIAuto-Android"><img src="https://img.shields.io/badge/Android-26%2B-brightgreen.svg?style=flat"></a>
  <a href="https://github.com/TommyLemon/UIGO/tree/master/UIAuto-Admin"><img src="https://img.shields.io/badge/Admin-brightgreen.svg?style=flat"></a>
...
<p align="center" >
  <a href="https://github.com/TommyLemon/UIGO#%E9%9B%86%E6%88%90%E5%88%B0%E8%A2%AB%E6%B5%8B%E9%A1%B9%E7%9B%AE">使用文档</a>
  <a href="https://search.bilibili.com/all?keyword=UIGO">视频教程</a>
  <a href="http://apijson.cn/unit">在线体验</a>
</p>

<p align="center" >
  <img src="https://raw.githubusercontent.com/TommyLemon/UIGO/master/UIGO-Admin/img/logo.png" />
</p>
...
<img width="1495" alt="image" src="https://raw.githubusercontent.com/TommyLemon/StaticResources/master/UIGO/UIGO-RandomTest-Parent-small.jpg">
...
<img width="1495" alt="image" src="https://github.com/TommyLemon/UIGO/assets/5738175/4c643a5a-b693-42a1-bb55-3eee61b97f2a">
<img width="1495" alt="image" src="https://github.com/TommyLemon/UIGO/assets/5738175/12b2a81b-bc41-413c-b748-956bbdec7409">
<img width="1495" alt="image" src="https://github.com/TommyLemon/UIGO/assets/5738175/842e1783-abc7-4cae-aaa5-f7693c69b4ce">


### 特点优势
相比 JUnit, JTest, Mockito, Mockk 等一堆 Compiling testing 工具：<br />
1.其它工具需要每个方法都写一大堆测试代码，需要开发成本、需要解决测试代码的 bug、业务代码更改后需要同步修改测试代码等；<br />
UIGO 不需要写任何代码，直接读取方法的属性，自动注入参数，拿到返回值和类成员变量，机器学习自动化校验。<br />
<br />
2.UIGO 这种 Runtime testing 工具无需 Mock 环境(Application, Context 等)，<br />
...
UIGO 会自动生成测试参数，并执行方法，拿到返回值等进行校验。<br />
泛型、接口等自动模拟，异步执行方法自动记录回调过程，都是零代码。<br />
<br />
[UIGO-Admin](https://github.com/TommyLemon/UIGO/tree/master/UIGO-Admin) 是类似 [APIAuto](https://github.com/TommyLemon/APIAuto) 的机器学习零代码测试工具（查看、上传、执行、测试 后端项目中的方法等），<br />
[UIGO-Java](https://github.com/TommyLemon/UIGO/tree/master/UIGO-Java) 提供扫描所有方法、执行某个方法两个 API （主要引入 [MethodUtil.java](https://github.com/TommyLemon/UIGO/blob/master/UIGO-Java/src/main/java/UIGO/MethodUtil.java) 这个类，里面已实现）。<br />
<br />

##### 通过扫描项目中的可访问的 package, class, method 来生成和导入测试用例  
<p align="center" >
  <a ><img src="https://raw.githubusercontent.com/TommyLemon/StaticResources/master/UIGO/UIGO-Method-List-small.jpg"></a>
</p>
<br />
...
<p align="center" >
  <a ><img src="https://raw.githubusercontent.com/TommyLemon/StaticResources/master/UIGO/UIGO-Test-interface-small.jpg"></a>
</p>
<br />

##### 通过简单配置自动调整参数组合，拿到返回结果后通过 前后结果对比 或 机器学习校验模型 来自动断言
<p align="center" >
  <a ><img src="https://raw.githubusercontent.com/TommyLemon/StaticResources/master/UIGO/UIGO-RandomTest-Parent-small.jpg"></a>
</p>
<p align="center" >
  <a ><img src="https://raw.githubusercontent.com/TommyLemon/StaticResources/master/UIGO/UIGO-RandomTest-Child-small.jpg"></a>
</p>
<br />

##### 后端不再需要像以下示例一样编写和维护大量单元测试用例代码（逻辑代码、注解代码等）：
<p align="center" >
  <a ><img src="https://raw.githubusercontent.com/TommyLemon/StaticResources/master/UIGO/UIGO-Compare-Code-small.jpg"></a>
</p>
<br />

##### 客户端可作为 HTTP Server 来为 UIGO 网页工具 提供远程调用的接口，效果同样：
<p align="center" >
  <a ><img src="https://user-images.githubusercontent.com/5738175/87251324-6b759900-c49d-11ea-8468-aaf26124b7e0.png"></a>
</p>
<p align="center" >
...
### 示例项目
[UIGO Java 后端 Server](https://github.com/TommyLemon/UIGO/tree/master/UIGO-Java-Demo)    在线 [测试](http://apijson.cn:8081) <br />
...
[UIGO Android 客户端 App](https://github.com/TommyLemon/UIGO/tree/master/UIGO-Android)    直接 [下载](https://github.com/TommyLemon/UIGO/releases/download/2.6.0/UIGOApp.apk) （第一次可能失败，返回报错 JSON，一般重试一次就可以）<br />
[APIJSON Android 客户端 App](https://github.com/APIJSON/APIJSON-Demo/blob/master/APIJSON-Android/APIJSONTest)    直接 [下载](https://github.com/TommyLemon/UIGO/releases/download/2.5.0/APIJSONTest.apk) （第一次可能失败，返回报错 JSON，一般重试一次就可以）
<br />
<br />

### 演讲视频
UIGO-机器学习自动化单元测试平台简介 <br />
https://www.bilibili.com/video/BV1Tk4y1R7Yo
<br />
<br />
UIGO-异步回调方法的零代码单元测试 <br />
https://www.bilibili.com/video/BV1kk4y1z7bW
<br />

其它
https://search.bilibili.com/all?keyword=UIGO
<br />

### 集成到被测项目
#### Java 后端 Server
##### 1.依赖 UIGO.jar 
放到你 [启动 Application 所在项目的 libs 目录](https://github.com/TommyLemon/UIGO/tree/master/UIGO-Java-Demo/libs)，然后 Eclipse Add to Build Path 或 Idea Add as Library <br />
https://github.com/TommyLemon/UIGO/tree/master/UIGO-Java-Demo/libs <br />
<br />
...
依赖方式同步骤 1。<br />
https://github.com/TommyLemon/UIGO/tree/master/UIGO-Java-Demo/libs <br />
依赖后需要在 [Application static 代码块](https://github.com/TommyLemon/UIGO/blob/master/UIGO-Java-Demo/src/main/java/UIGO/demo/DemoApplication.java) 中初始化
```java
    static {
        UIGOApp.init();
    }
...
```
参考 [DemoController](https://github.com/TommyLemon/UIGO/blob/master/UIGO-Java-Demo/src/main/java/UIGO/demo/controller/DemoController.java) <br />
<br />

##### 4.配置环境相关类及自定义处理逻辑
拦截 [MethodUtil](https://github.com/TommyLemon/UIGO/blob/master/UIGO-Java/src/main/java/UIGO/MethodUtil.java) 类中的 INSTANCE_GETTER, JSON_CALLBACK, CLASS_LOADER_CALLBACK 等 interface 的回调方法，<br />
可以支持获取 Context 等环境相关类的实例、转 JSON 对象时过滤特定类、其它自定义逻辑处理，参考 [DemoApplication](https://github.com/TommyLemon/UIGO/blob/master/UIGO-Java-Demo/src/main/java/UIGO/demo/DemoApplication.java)<br />
<br /><br />

#### Android 客户端 App
##### 1.依赖 UIGO-Apk
把 [UIGO-Apk](https://github.com/TommyLemon/UIGO/tree/master/UIGO-Android/UIGO-Apk) 导入到你项目 [app moudule 所在目录](https://github.com/TommyLemon/UIGO/tree/master/UIGO-Android)，[settings.gradle](https://github.com/TommyLemon/UIGO/tree/master/UIGO-Android/settings.gradle) 中
```groovy
include ':UIGO-Apk'
```
[app moudule 目录](https://github.com/TommyLemon/UIGO/tree/master/UIGO-Android/app)，[build.gradle](https://github.com/TommyLemon/UIGO/tree/master/UIGO-Android/app/build.gradle) 中
```groovy
dependencies {
    api project(':UIGO-Apk')
}
```
<br />

##### 2.初始化 UIGO
在 [Application onCreate 方法](https://github.com/TommyLemon/UIGO/blob/master/UIGO-Android/app/src/main/java/UIGO/demo/DemoApp.java) 中初始化
```java
    @Override
...
##### 3.提供 UIGO 管理界面入口
在 [AndroidManifest.xml](https://github.com/TommyLemon/UIGO/blob/master/UIGO-Android/app/src/main/AndroidManifest.xml) 中注册 [UIGOActivity](https://github.com/TommyLemon/UIGO/blob/master/UIGO-Android/UIGO-Apk/src/main/java/UIGO/apk/UIGOActivity.java)
```xml
<manifest ... >
    <application ... >
      
        <activity
            android:name="UIGO.apk.UIGOActivity"
...
```xml
    <Button
        ...
        android:text="UIGOActivity"
        android:textAllCaps="false"
        />
```
参考 [layout/activity_main](https://github.com/TommyLemon/UIGO/blob/master/UIGO-Android/app/src/main/res/layout/activity_main.xml) <br />
<br />
点击这个入口跳转到 [UIGOActivity](https://github.com/TommyLemon/UIGO/blob/master/UIGO-Android/UIGO-Apk/src/main/java/UIGO/apk/UIGOActivity.java)
```java
    public void onClickUnit(View v) {
        startActivity(UIGOActivity.createIntent(this));
    }
```
参考 [MainActivity](https://github.com/TommyLemon/UIGO/blob/master/UIGO-Android/app/src/main/java/UIGO/demo/MainActivity.java) <br />
<br />

##### 4.配置环境相关类及自定义处理逻辑
在 [Application onCreate 方法](https://github.com/TommyLemon/UIGO/blob/master/UIGO-Android/app/src/main/java/UIGO/demo/DemoApp.java) 中配置，参考 [Java 后端 Server 中 4.配置环境相关类及自定义处理逻辑](https://github.com/TommyLemon/UIGO#4%E9%85%8D%E7%BD%AE%E7%8E%AF%E5%A2%83%E7%9B%B8%E5%85%B3%E7%B1%BB%E5%8F%8A%E8%87%AA%E5%AE%9A%E4%B9%89%E5%A4%84%E7%90%86%E9%80%BB%E8%BE%91)
<br />
<br />

### 部署后台管理工具
可以直接[下载源码](https://github.com/TommyLemon/UIGO/archive/master.zip)解压后用浏览器打开 [UIGO-Admin](https://github.com/TommyLemon/UIGO/tree/master/UIGO-Admin)/index.html，建议用 Chrome 或 火狐 (Safari、Edge、IE 等可能有兼容问题)。<br />
...
如果测试 Android/iOS App，需要保证 手机/平板 与 使用 UIGO-Admin 网页的电脑 连接同一个局域网，<br />
...
可以使用以下几种方式：
#### 1.远程扫描方法
https://github.com/TommyLemon/UIGO/blob/master/README.md#%E8%BF%9C%E7%A8%8B%E6%89%AB%E6%8F%8F%E6%96%B9%E6%B3%95
...
例如：
http://apijson.cn/unit/?send=true&type=JSON&url=UIGO.test.TestUtil.minus&json={%22static%22:true,%22methodArgs%22:[{%22type%22:%22long%22,%22value%22:1},{%22type%22:%22long%22,%22value%22:2}]}
...
### 远程扫描方法
UIGO-Admin 登录后点击 设置项 \[查看、同步方法文档]，等返回方法属性 JSON 后点 \[上传] 按钮
![image](https://user-images.githubusercontent.com/5738175/172366167-87b5de56-16c0-4a44-bed7-6a6fe76a4209.png)

对应发送 HTTP 请求 <br />
[POST /method/list](https://github.com/TommyLemon/UIGO/blob/master/UIGO-SpringBoot-SDK/src/main/java/UIGO/boot/UIGOController.java#L43-L50)
```js
{
...
https://github.com/TommyLemon/UIGO/blob/master/UIGO-Java/src/main/java/UIGO/MethodUtil.java#L287-L300
...
```js
{
    ...
    "methodArgs": [
        ...
        {   // 支持各种类型，例如 UIGO.demo.domain.User, List<String>, annotation.Annotation[]，未注册的要写完整全路径
            "type": "double",
            "value": 2
        }
    ]
...
对应发送 HTTP 请求  <br />
[POST /method/invoke](https://github.com/TommyLemon/UIGO/blob/master/UIGO-SpringBoot-SDK/src/main/java/UIGO/boot/UIGOController.java#L52-L102)
```js
{
    "package": "UIGO.test",
    "class": "TestUtil",
...
对应调用 Java 方法  <br />
UIGO.test.TestUtil.divide(double, double)
```java
    public static double divide(double a, double b) {
        return a / b;
    }
```
https://github.com/TommyLemon/UIGO/blob/master/UIGO-Java/src/main/java/UIGO/test/TestUtil.java#L56-L58

<img width="1495" alt="image" src="https://user-images.githubusercontent.com/5738175/224038704-fef31759-c349-40cb-a252-e0c8cff55110.png">

异步回调方法  <br />
UIGO.test.TestUtil.computeAsync
```js
{
    "static": true,
    "methodArgs": [
        ...
        "long:2",
        {
            "type": "UIGO.test.TestUtil$Callback",
            "value": {
...
对应调用 Java 方法  <br />
UIGO.test.TestUtil.computeAsync(long, long, Callback)
```java
...
```
https://github.com/TommyLemon/UIGO/blob/master/UIGO-Java/src/main/java/UIGO/test/TestUtil.java#L95-L117

 <br /> <br />

详细说明见 MethodUtil.invokeMethod 的注释 <br />
https://github.com/TommyLemon/UIGO/blob/master/UIGO-Java/src/main/java/UIGO/MethodUtil.java#L353-L424
...
### 统计覆盖率
<img width="1495" alt="image" src="https://github.com/TommyLemon/UIGO/assets/5738175/e3e54fd5-9a42-4a26-a58d-853168fe0682">
...
mvn clean package
```
完成后 target 目录应该有 UIGO-java-demo.jar(springboot-maven-plugin 重新打包) 和 UIGO-java-demo.jar.original(maven 直接打包) 这样的两个 jar 包

#### 2.使用 JaCoCo Agent 作为 Java Agent 来运行 jar 包
```sh
java -javaagent:libs/jacocoagent.jar=destfile=../jacoco.exec,includes=*,output=tcpserver,port=6300,address=127.0.0.1 -jar target/UIGO-java-demo-2.9.0.jar
```
...
https://github.com/TommyLemon/UIGO/issues/11
