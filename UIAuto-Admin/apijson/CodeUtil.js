/*Copyright ©2017 TommyLemon(https://github.com/TommyLemon/UIAuto)
  ...
  parseJavaBean: function(docObj, clazz, database) {
    ...
    if (list != null) {
      ...
      for (var i = 0; i < list.length; i++) {
        ...
        doc += '/**'
          + '\n *UIAuto 自动生成 JavaBean\n *主页: https://github.com/TommyLemon/UIAuto'
