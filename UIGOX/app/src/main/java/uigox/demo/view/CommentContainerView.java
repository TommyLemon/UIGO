 ...
 * @author Lemon
 * @use
 * <br> CommentContainerView commentContainerView = new CommentContainerView(context);
 * <br> adapter中使用:[具体参考.DemoAdapter2(getView使用自定义View的写法)]
 * <br> convertView = commentContainerView.createView();
 * <br> commentContainerView.bindView(data, position, viewType);
 * <br> 或  其它类中使用:
 * <br> containerView.addView(commentContainerView.createView());
 ...
 * <br> commentContainerView.setOnViewClickListener(onViewClickListener);//非必需
 * <br> ...
 */
public class CommentContainerView extends BaseView<List<CommentItem>> {
	...
	public CommentContainerView(Activity context) {
		super(context, R.layout.comment_container_view);
