...
import uigox.demo.view.CommentView;
import uigox.demo.view.CommentView.OnCommentClickListener;
import uigox.demo.view.CommentView.OnShowAllListener;
import zuo.biao.library.base.BaseAdapter;

/**评论列表
 * @author Lemon
 */
public class CommentAdapter extends BaseAdapter<CommentItem, CommentView> {
