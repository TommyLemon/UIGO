...
public final class SettingUtil {
	 ...
	 * TODO 改为你的存图片的服务器地址
	 */
	public static String IMAGE_BASE_URL = "http://demo.upaiyun.com";
	 ...
	 * TODO 改为你的正式服务器地址
	 */
	public static String URL_SERVER_ADDRESS_NORMAL_HTTP = "http://apijson.cn:9090/";//正式服务器
	/**
	 * TODO 改为你的正式服务器地址
	 */
	public static String URL_SERVER_ADDRESS_NORMAL_HTTPS = "http://apijson.cn:9090/";//正式服务器
	/**
	 * TODO 改为你的测试服务器地址,如果有的话
	 */
	public static String URL_SERVER_ADDRESS_TEST = "http://apijson.cn:9090/";//测试服务器
